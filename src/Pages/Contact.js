...
function Contact() {
  ...
  return (
    <main className="container mx-auto max-width section">
      <h1 className="text-rose-600 text-3xl mb-7">Connect with me,👇 : </h1>

<ul className="flex justify-evenly items-center mx-10">
...
<li>
      ...
      <h3 className="text-center text-xl md:text-2xl lg:text-3xl text-gradient font-semibold md:font-bold pt-3 pb-14 mt-5">
